      ...
      <div className="max-w-4xl mx-auto px-2 sm:px-3 md:px-4 lg:px-6 py-5 sm:py-7 md:py-10 lg:py-14">
        ...
        <div className="space-y-4 sm:space-y-5 md:space-y-6">
          <Section title="Introduction" icon={Shield}>
            <p>
              Welcome to{" "}
              <span className="font-semibold text-[#FF7407]">Mr Halwai</span>{" "}
              (mrhalwai.in). Your privacy is important to us. This Privacy
              Policy explains how we collect, use, and protect your personal
              data.
            </p>
          </Section>

          <Section title="Information We Collect" icon={Clipboard}>
        ...
        <div className="mt-10 sm:mt-12 md:mt-14 p-3 sm:p-4 md:p-5 lg:p-6 bg-white/80 backdrop-blur border-l-4 border-[#FF7407] rounded-lg sm:rounded-xl">
          <p className="text-gray-700 text-xs sm:text-sm leading-relaxed">
            <span className="font-semibold text-[#FF7407]">
              Your Privacy Matters:
            </span>{" "}
            We are committed to protecting your personal information and
            maintaining your trust. If you have any questions about this Privacy
    ...
    <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
      <div className="flex-shrink-0">
        <div className="flex items-center justify-center h-10 w-10 sm:h-11 md:h-12 rounded-lg sm:rounded-xl bg-gradient-to-br from-[#FF7407] to-[#F6A51A] shadow-lg">
          <Icon size={18} className="sm:w-5 md:w-6 text-white" />
        </div>
      </div>
