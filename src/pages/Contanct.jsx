...
function Contanct() {
  return (
    <div className="w-full bg-gradient-to-br from-[#FFFBE9] via-orange-100 to-amber-100">
      <section className="max-w-6xl mx-auto px-6 py-12 md:py-16">
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="rounded-3xl border border-orange-200 bg-gradient-to-br from-white to-orange-50/30 p-6 shadow-lg">
        ...
        <div className="mt-10 rounded-3xl border border-orange-200 bg-gradient-to-br from-white to-orange-50/30 p-6 shadow-sm hover:shadow-lg transition-shadow">
